...
void GamePlayerVsAI::animateScalingHelpBubble(float endScale, float howMuchScaleInOneStep)
{
...
void GamePlayerVsAI::animateDisappearingHelpBubble(const sf::Time & dt)
{
